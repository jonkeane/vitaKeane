...
\begin{hangparas}{1em}{1}
\-\years{to appear}Diane Brentari, Alessio Di Renzo, \textbf{Jonathan Keane}, Virginia Volterra. Cultural, and Linguistic Sources of a Handshape Distinction Expressing Agentivity. In \textit{Topics in Cognitive Science}.
...
\begin{hangparas}{1em}{1}
\-\years{forthcoming}\textbf{Jonathan Keane}, Diane Brentari, Jason Riggle. Segmentation and pinky extension in {\textsc{asl}} fingerspelling. In Eric Raimy, Chuck Cairns eds., \textit{The Segment in Phonology and Phonetics}.
