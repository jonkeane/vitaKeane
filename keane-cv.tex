...
\begin{hangparas}{1em}{1}
\-\years{2014}Leah Geer, \textbf{Jonathan Keane}. Exploring Factors that Contribute to Successful Fingerspelling Comprehension. In Nicoletta Calzolari, Khalid Choukri, Thierry Declerck, Hrafn Loftsson, Bente Maegaard, Joseph Mariani, Asuncion Moreno, Jan Odijk, Stelios Piperidis eds., \textit{Proceedings of the Ninth International Conference on Language Resources and Evaluation (LREC'14)}.
...
\-\years{2013}\textbf{Jonathan Keane}, Diane Brentari, Jason Riggle. ``Dispelling prescriptive rules in {\textsc{asl}} fingerspelling: the case of -{\textsc{e}}-'' Theoretical Issues in Sign Language Research 11; London, UK
